...
import type { RoccoSpriteMessageOptions, RoccoSpriteMessageStyle } from '../../../engine/video/messages';
...
type RoccoDialoguePhase = 'idle' | 'awaiting-choice' | 'waiting-player' | 'waiting-bridge' | 'waiting-npc';
