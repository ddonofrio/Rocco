...
export interface RoccoAssetPreloaderProgress {
  loaded: number;
  total: number;
  percent: number;
}

export type RoccoAssetPreloaderProgressCallback = (progress: RoccoAssetPreloaderProgress) => void;

export class RoccoAssetPreloader {
  private loaded = 0;
  private total = 0;
  private readonly onProgress: RoccoAssetPreloaderProgressCallback;

  constructor(onProgress: RoccoAssetPreloaderProgressCallback = () => {}) {
  ...
  getProgress(): RoccoAssetPreloaderProgress {
