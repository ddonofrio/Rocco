...
export const englishNetherText: RoccoTextCatalog['nether'] = {
  ...
  officeReading: {
    ...
    identityCallLine: 'Rocco, come here, I know it is you.',
    identityChoices: [
      'Uh, no, Rulo, I am Rulo',
      'Rocco? Hmm... no, I do not know any Rocco',
      'I have been told I look like him',
      'Look behind you, a three-headed monkey',
    ],
    identityFoolGuyspriteLine: 'You do not think I will be foolish enough to fall for that.',
    identityFoolRoccoLine: 'But look! It is true',
    identityFoolFinalLine: 'I thought you were more serious.',
    identityConfessionLines: [
      'Rocco, I have freed you...',
      '...I had to check that it was you...',
      '...that is why I put you through these tests...',
      '...I needed to get you out of the game and so...',
      '...I left the magazine I built myself from here...',
      '...and I put faith in the code in the console so that...',
      '...breaking a necklace would allow a portal to open...',
      '...to bring you here, but I had to keep pretending...',
      '...until I knew it was you; I only knew your code...',
      '...I had never seen your sprite.',
    ],
    identityFinalChoices: [
      'So why did you keep calling security all the time?',
      'Much better than being rescued naked from the water by a hook.',
      'My sprite?',
    ],
    identitySecurityReplyLines: [
      'I have not called security at any point...',
      "...They are only memories in your player's mind from previous games...",
      '...but I can assure you I would never call security.',
    ],
    identityHookReplyLine: 'I did not have as much budget as the Wachowski sisters.',
    identitySpriteReplyLine: 'Your avatar. I only knew how it worked.',
    identityEscapeIntroLine: 'Actually, I brought you here to give you a choice.',
    identityEscapeChoices: [
      'What choice? Like the red and blue pill?',
      'What are you talking about, Spriteguy?',
    ],
    identityPathLines: [
      'I am talking about two possible paths,...',
      '...two choices that you will have to make:',
      'You can choose to return to the game, but this time...',
      '...as an invincible superhuman...',
      '...or you can see the real world that the console...',
      '...has hidden from you all these years...',
    ],
    identityPathClarificationLines: [
      [
        'Okay, let me put it another way...',
        '...you can return to the game with powers...',
        '...or stay here and see the real world.',
      ],
      ['In short:', 'Game with powers...', '...or console and real world.'],
      ['Two options:', 'One: return to the game, invincible.', 'Two: stay here, real world.'],
    ],
    identityPathChoices: [
      'I choose to return to the game as a superhuman',
      'I choose to stay in the console and explore the real world',
    ...
    missingCartridgeButton: 'I do not have it',
    roccoMissingCartridgeQuestion: 'What cartridge?',
    guyspriteCartridgeExplanation: 'This game is composed of...\n\n...several cartridges, like chapters...',
    roccoSecondQuestion: 'And what shall we do now?',
    guyspriteMicrowavePizzas: 'Shall we make some...\n\n...microwave pizzas?\nI am hungry.',
    roccoAgrees: 'okay',
