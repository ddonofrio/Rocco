...
export const spanishInventoryText: RoccoTextCatalog['inventory'] = {
  ...
  fullLines: ['No tengo espacio en mis bolsillos para m\u00e1s cosas'],
  keysLabel: 'Llaves',
  ...
  twentyEurosLabel: '20\u20ac',
  bataLabel: 'Bata',
  floatingAmuletLabel: 'Amuleto flotante',
  spiralRazorLabel: 'Navaja turritela',
  abyssalTalismanLabel: 'Talism\u00e1n abisal',
  coralRelicLabel: 'Reliquia coralina',
  magazineOnSelfLine: 'Me gustar\u00eda leerla, pero sentado.',
  bataOnSelfLine: 'Me la pongo.',
  bataAlreadyOnSelfLine: 'Ya la llevo puesta.',
  cannotUseItemLines: [
  ...
  moneyOnStanSleepingLines: ['Naah, est\u00e1 durmiendo.'],
  keysOnStanSleepingLines: ['Naah, est\u00e1 durmiendo.'],
