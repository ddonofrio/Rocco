...
export const spanishNetherText: RoccoTextCatalog['nether'] = {
  ...
  officeReading: {
    ...
    roccoMissingCartridgeQuestion: '¿qué cartucho?',
    guyspriteCartridgeExplanation: 'Este juego se compone de...\n\n...varios cartuchos, como capítulos...',
    roccoSecondQuestion: '¿Y ahora qué hacemos?',
    guyspriteMicrowavePizzas: '¿Nos hacemos unas...\n\n...pizzas al microhondas?\nYa hace hambre.',
    roccoAgrees: 'vale',
