...
export function createDefaultSpriteDefinition(
  ...
  return {
    ...
    frames: [
      {
        id: 'run-left-a',
        imageId: 'rocco-run-left-1',
        durationMs: 120,
        hitbox: makeDefaultHitbox(),
      },
      {
        id: 'run-left-b',
        imageId: 'rocco-run-left-2',
        durationMs: 120,
      },
      {
        id: 'run-right-a',
    ...
    animations: {
      ...
      'run-left': {
        ...
        frames: [
          { frameId: 'run-left-a', durationMs: 120 },
          { frameId: 'run-left-b', durationMs: 120 },
        ],
      },
      'run-right': {
        id: 'run-right',
        ...
        frames: [
          { frameId: 'run-right-a', durationMs: 120 },
          { frameId: 'run-right-b', durationMs: 120 },
        ],
      },
