...
import type { RoccoConsoleFlags } from '../../src/engine/engine-sdk';
...
vi.mock('../../src/engine/cartridge-menu/cartridge-menu', () => ({
...
import { RoccoCartridgeManager } from '../../src/engine/cartridge-manager';
